 ...
 */
public class PS2Fragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bundle.putString("listboolkey" , "isPS2");
        bundle.putString("endpoints" , EndPoints.PS2);
        bundle.putInt("layoutres", R.layout.fragment_listview);
        bundle.putString("tablename", DBValues.PS2_TABLE);
        bundle.putString("actionbartitle" , "Play Station 2 Cheater");

 ...
 */
public class Xbox360Fragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bundle.putString("listboolkey" , "isXBOX360");
        bundle.putString("endpoints" , EndPoints.XBOX360);
        bundle.putInt("layoutres", R.layout.fragment_listview);
        bundle.putString("tablename", DBValues.XBOX360_TABLE);
        bundle.putString("actionbartitle" , "Xbox 360 Cheater");

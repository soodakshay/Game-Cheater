 ...
 */
public class WiiFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bundle.putString("listboolkey" , "isWII");
        bundle.putString("endpoints" , EndPoints.WII);
        bundle.putInt("layoutres", R.layout.fragment_listview);
        bundle.putString("tablename", DBValues.WII_TABLE);
        bundle.putString("actionbartitle" , "Nintendo Wii Cheater");

...
public class DSFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bundle.putString("listboolkey" , "isDS");
        bundle.putString("endpoints" , EndPoints.DS);
        bundle.putInt("layoutres", R.layout.fragment_listview);
        bundle.putString("tablename", DBValues.DS_TABLE);
        bundle.putString("actionbartitle" , "Nintendo DS Cheater");

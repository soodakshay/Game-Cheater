 ...
 */
public class PS4Fragment  extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bundle.putString("listboolkey" , "isPS4");
        bundle.putString("endpoints" , EndPoints.PS4);
        bundle.putInt("layoutres", R.layout.fragment_listview);
        bundle.putString("tablename", DBValues.PS4_TABLE);
        bundle.putString("actionbartitle" , "Play Station 4 Cheater");

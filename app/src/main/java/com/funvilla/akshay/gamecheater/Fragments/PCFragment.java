...
public class PCFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bundle.putString("listboolkey" , "isPC");
        bundle.putString("endpoints" , EndPoints.PC);
        bundle.putInt("layoutres", R.layout.fragment_listview);
        bundle.putString("tablename", DBValues.PC_TABLE);
        bundle.putString("actionbartitle" , "PC Cheater");
